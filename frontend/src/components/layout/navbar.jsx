  ...
  return (
    <>
      <div className="bg-miColor  text-black absolute top-0 w-full right-0 flex flex-row justify-between px-20 py-6 items-center">
        <div>
          <Link to="/"><img className="h-28" src="asd" /></Link>
        </div>
        <div className="mx-auto block ">
          <div className="flex flex-row items-center">
            <input className=" w-[50rem] bg-white outline-none  text-letrasBuscador border rounded-full border-letrasBuscador px-4 py-2 mt-2" placeholder="Busca tus flores" type="search"></input>
            <i class="bi bi-search"></i>
            <box-icon className="search-bot" name='search-alt-2' color='#ffffff'></box-icon>
            <div className="ml-[11rem] gap-[12rem]">
